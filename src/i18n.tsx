...
const messages: Record<string, Record<Language, string>> = {
  ...
  "landing.credit": { ar: "رصيد بداية متاح فوراً", en: "Starter credit available immediately" },
  ...
  "workflow.body": { ar: "تشاهد مسار كل طلب وسبب تأهيل كل عميل، بينما تحفظ وصلة السجل الكامل والصلاحيات.", en: "See every request stage and why each lead qualified, while Wasla preserves the full record and permissions." },
  ...
  "auth.storyBody": { ar: "وصلة تحفظ كل طلب، تشغّل مسار البحث والتأهيل، وتعرض لفريقك سبب الترشيح قبل كشف بيانات التواصل.", en: "Wasla stores every request, runs sourcing and qualification, and shows why a lead fits before revealing contact details." },
  ...
  "auth.createBody": { ar: "لا بطاقة بنكية. أنشئ حسابك وابدأ أول طلب حتى قبل توثيق الجوال.", en: "No card required. Create your account and launch your first request before phone verification." },
  ...
  "console.modelBody": { ar: "يُحفظ كل طلب داخل مساحتك، ويثريه الوكيل، ولا تُكشف البيانات إلا عندما تكون مفيدة لفريقك.", en: "Every request is stored in your workspace, enriched by the agent, and revealed only when useful to your team." },
